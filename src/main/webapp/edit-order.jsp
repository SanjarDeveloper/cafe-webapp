        ...
        <div class="card-body">
          ...
          <div class="form-group">
            <label>Customer Name:</label> <input type="text"
                                                 ...
                                                 class="form-control" id="customer-name" aria-describedby="customer-name" name="customer-name" readonly>
          </div>
          <%
          ...
          %>
          <div class="form-group">
            <label>Food: №<%=counter++%></label> <input type="text" class="form-control"
          ...
          <a href="orders.jsp"><button type="button" class="btn btn-primary badge-pill btn-block">Back</button></a>
          </form>
        </div>
      </div>
    </div>
